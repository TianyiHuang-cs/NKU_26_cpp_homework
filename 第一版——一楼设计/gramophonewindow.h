...
public:
    ...
    // 放入物品：传入物品ID和图标
    void setItem(int itemId, const QPixmap &icon, const QString &name);
...
public:
    ...
    void placeItemIntoSlot(int slotIndex, int itemId,
...
signals:
    ...
    void returnItemToBag(int slotIndex, int itemId, const QPixmap &icon, const QString &itemName);
